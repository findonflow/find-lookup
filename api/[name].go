...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf(`https://prod-test-net-dashboard-api.azurewebsites.net/api/company/04bd44ea-0ff1-44be-a5a0-e502802c56d8/search?eventType=A.aa7481821839f36d.FIND.Register&name="%s"`, name)
